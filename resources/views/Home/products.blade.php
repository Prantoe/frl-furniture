    ...
    <body class="bg-backgroundHeader overflow-x-hidden antialiased">
        ...
        <nav
            ...
            <a href="{{ url('productsList') }}"
                ...
                class="ml-0 mr-3 font-bold duration-100 md:ml-12 md:mr-3 lg:mr-8 transition-color hover:text-brown">Semua
                Produk</a>
            @foreach($categories as $key => $value)


                <a href="{{ url('/productsList?id='.$value->id) }}"

                    class="text-brown mr-3 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-white">{{ $value->name }}</a>
            @endforeach
        ...
        <div class="container mx-auto  space-y-2 mt-10 lg:space-x-0 lg:space-y-2 lg:gap-4 lg:grid lg:grid-cols-4">
            ...
            @foreach($products as $key => $value)
                <div class="max-w-xs cursor-pointer ml-8 mb-5 bg-white  rounded-lg hover:shadow-2xl">
                    ...
                    <div class="px-6 py-4">
                          <h4 class="text-xl  text-choco font-bold cursor-pointer">{{ $value->name }}</h4>
                          <p class="mt-1  text-greyold cursor-pointer">Rp.{{ $value->price }},-</p>
                          <p class="mt-1  text-greyold cursor-pointer">{{ $value->description }}</p>
        ...
        <footer class="px-4 pt-12 pb-8 lg:mt-10 text-white bg-white border-t border-gray-200">
