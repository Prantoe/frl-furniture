<div id="sideBar"
    class="relative w-1/6 md:w-2/4 flex flex-col flex-wrap bg-white border-r p-6 flex-none md:-ml-64 md:fixed md:top-0 md:z-30 md:h-screen md:shadow-xl animated faster">
