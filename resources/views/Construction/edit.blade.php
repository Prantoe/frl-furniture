                ...
                <div class="card-body mt-20 block p-10 ">
                    <div class="flex flex-col">
                        <div class="flex flex-row justify-between items-center">
                            <h1 class="font-extrabold text-lg">Edit Product Construction</h1>
                        </div>
                        <div class="overflow-x-auto sm:-mx-6 lg:-mx-12">
                            <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <form action="{{ route('constructions.update',$construction->id) }}"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input value="{{ $construction->title }}"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="form-outline mb-4 w-full">
                                            <textarea
                                                ...
                                                name="description" rows="4">{{ $construction->description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex mt-5">
                                        ...
                                        <a href="{{ route('constructions.index') }}" class="btn-bs-info hover:bg-orange-400 ml-5">Back</a>
